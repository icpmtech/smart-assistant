...
namespace Tutorial.Bot
{
    ...
    public static class Cards
    {
        public static Attachment CreateAdaptiveCardAttachment()
        {
            ...
            string[] paths = { ".", "Cards", "promptCard.json" };
        ...
        public static ThumbnailCard GetHeroCard(string body)
        {
            var heroCard = new ThumbnailCard
            {
                ...
                Buttons = new List<CardAction> { new CardAction(ActionTypes.ImBack, "Sim", value: "Sim"),
                new CardAction(ActionTypes.ImBack, "Não", value: "Não") },
            };
